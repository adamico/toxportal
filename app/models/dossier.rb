...
class Dossier
  ...
  field :examen_histologique,           type: Integer
  field :examen_histologique_resultat,  type: String
  field :deces_type,                    type: Integer
  field :deces_mecanisme,               type: Integer
